...
import static itc.mervat.com.bakingapp.RecipeUi.BakingActivity.SELECTED_INDEX;
import static itc.mervat.com.bakingapp.RecipeUi.BakingActivity.SELECTED_RECIPES;
import static itc.mervat.com.bakingapp.RecipeUi.BakingActivity.SELECTED_STEPS;
...
public class BakingStepDetailFragment extends Fragment  {
   ...
   private ListItemClickListener itemClickListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        itemClickListener =(BakingDetailActivity)getActivity();
        ...
        View rootView = inflater.inflate(R.layout.baking_step_detail_fragment, container, false);
        ...
        if (rootView.findViewWithTag("sw600dp-port-recipe_step_detail")!=null) {
           recipeName=((BakingDetailActivity) getActivity()).recipeName;
           ((BakingDetailActivity) getActivity()).getSupportActionBar().setTitle(recipeName);
        }
        ...
        if (!videoURL.isEmpty()) {
           ...
           if (rootView.findViewWithTag("sw600dp-land-recipe_step_detail")!=null) {
            ...
            player=null;
            simpleExoPlayerView.setForeground(ContextCompat.getDrawable(getContext(), R.drawable.ic_visibilityoff));
...
//                Toast.makeText(getActivity(),"You already are in the First step of the recipe", Toast.LENGTH_SHORT).show();
                Snackbar.make(view,"You already are in the First step of the recipe",Snackbar.LENGTH_SHORT).show();
            }
        }});
        ...
        mNextstep.setOnClickListener(new View.OnClickListener() {
            ...
            if (steps.get(selectedIndex).getId() < steps.get(lastIndex).getId()) {
             ...
             //   Toast.makeText(getContext(),"You already are in the Last step of the recipe", Toast.LENGTH_SHORT).show();
                Snackbar.make(view,"You already are in the Last step of the recipe",Snackbar.LENGTH_SHORT).show();
